      ...
      {heroVideo && (
        <section style={{ background: '#0d1f3a', padding: 0, overflow: 'hidden' }}>
          {isYoutube ? (
            ...
            <video src={heroVideo} autoPlay loop muted playsInline preload="metadata" style={{ width: '100%', display: 'block', verticalAlign: 'bottom' }} />
          )}
        </section>
      )}
      ...
      {heroVideo2 && (
        <section style={{ background: '#0d1f3a', padding: 0, overflow: 'hidden' }}>
          {isYoutube2 ? (
            ...
            <video src={heroVideo2} autoPlay loop muted playsInline preload="metadata" style={{ width: '100%', display: 'block', verticalAlign: 'bottom' }} />
          )}
        </section>
      )}
