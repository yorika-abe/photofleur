...
export default function AdminBookingsPage() {
  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '24px 16px' }}>
      ...
      <style>{`.adm-tabs { display:flex; gap:0; margin:8px 0 24px; border-bottom:2px solid #e5e5e5; overflow-x:auto; flex-wrap:nowrap; -webkit-overflow-scrolling:touch; scrollbar-width:none; } .adm-tabs::-webkit-scrollbar{display:none} .adm-tab { padding:10px 20px; font-weight:600; font-size:15px; white-space:nowrap; flex-shrink:0; } @media(max-width:640px){ .adm-tab { padding:10px 12px; font-size:13px; } }`}</style>
