    ...
    <div className="nl-outer" style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#f5f7fb' }}>
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .nl-left { width: 100% !important; display: flex !important; flex-direction: column !important; overflow: visible !important;
                     border-right: none !important; border-bottom: 1px solid #e0e8f0; height: auto !important;
                     padding: 0 !important; gap: 0; flex-shrink: 0 !important; }
          ...
          .nl-template-row { display: flex !important; flex-direction: row !important; overflow-x: auto !important; overflow-y: hidden !important;
                             padding: 6px 8px !important; gap: 4px; align-items: flex-start; border-bottom: 1px solid #f0f0f0; }
          .nl-block-row { display: flex !important; flex-direction: row !important; overflow-x: auto !important; overflow-y: hidden !important;
                          padding: 6px 8px !important; gap: 4px; align-items: flex-start; }
          .nl-left-section { display: flex !important; flex-direction: row !important; gap: 4px; border-top: none !important;
                             border-left: none !important; margin-top: 0 !important; padding-top: 0 !important;
                             padding-left: 0 !important; flex-shrink: 0 !important; align-items: flex-start; }
