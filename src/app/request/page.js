        ...
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
            ...
            <div>
              ...
              <div style={{ background: '#fff', borderRadius: 12, padding: '20px 24px', border: '1px solid #d6ecf5' }}>
                <p style={{ fontSize: 14, lineHeight: 2, color: '#3a3050', margin: 0 }}>
                  お申し込み後、会員マイページよりリクエスト撮影の確認ステータスが表示されます。<br />
                  モデル回答待ち → モデル回答済み・確認中 → （スタッフ募集中） → 確定 or 申請却下<br />
                  の流れになります。<br /><br />
                  確定後LINEにて通知いたします。リンクもしくはマイページより申し込みを確定してご予約ください。<br />
                  確定後はマイページのリクエスト撮影申請の表示部分に「申し込みキャンセルする」が選択できるようになりますので、予約前にキャンセルの場合はこちらからお手続きください。<br /><br />
                  確定後のキャンセルはキャンセル料はいただきませんが、続く場合はご利用を制限させていただく場合がございます。<br />
                  ご予約後のキャンセルは100%キャンセル料をいただきます。<br /><br />
                  ご提示いただいた日程でスケジュールが合わない場合、申請却下となる場合がございます。<br />
                  LINEにて結果はお知らせいたします。ご了承ください。
                </p>
              </div>
            </div>
