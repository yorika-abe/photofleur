...
export const DEFAULTS = {
  ...
  admin_request_cancelled: `【🔗❌リク撮キャンセル】\n確定前にカメラマンにより\nキャンセルされました`,
  request_cancel_model: `❌📸リク撮申請キャンセルのお知らせ\n\n{{booking_details}}\n\n【理由】\nカメラマンにより確定前にキャンセルされました`,
  request_cancel_staff: `❌📸スタッフが確定していた\nリク撮申請キャンセルのお知らせ\n\n{{booking_details}}\n\n【理由】\nカメラマンにより確定前にキャンセルされました`,
